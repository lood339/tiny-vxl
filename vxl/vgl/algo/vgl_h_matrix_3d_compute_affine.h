...
class vgl_h_matrix_3d_compute_affine : public vgl_h_matrix_3d_compute
{
 ...
 public:
   ...
   int minimum_number_of_correspondences() const override { return 4; }
    static constexpr int TM_UNKNOWNS_COUNT = 9;
    static constexpr double DEGENERACY_THRESHOLD = 0.00001;
};
constexpr int vgl_h_matrix_3d_compute_affine::TM_UNKNOWNS_COUNT;
constexpr double vgl_h_matrix_3d_compute_affine::DEGENERACY_THRESHOLD;
