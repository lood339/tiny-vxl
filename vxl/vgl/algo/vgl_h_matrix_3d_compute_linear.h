...
class vgl_h_matrix_3d_compute_linear : public vgl_h_matrix_3d_compute
{
 protected:
  ...
  inline bool compute_p(std::vector<vgl_homg_point_3d<double> > const& points1,
  ...
  inline bool solve_linear_problem(std::vector<vgl_homg_point_3d<double> > const& p1,
 ...
 public:
   ...
   int minimum_number_of_correspondences() const override { return 5; }
    ...
    static constexpr int TM_UNKNOWNS_COUNT = 16;
    static constexpr double DEGENERACY_THRESHOLD = 0.00001;
};

constexpr int vgl_h_matrix_3d_compute_linear::TM_UNKNOWNS_COUNT;
constexpr double vgl_h_matrix_3d_compute_linear::DEGENERACY_THRESHOLD;
