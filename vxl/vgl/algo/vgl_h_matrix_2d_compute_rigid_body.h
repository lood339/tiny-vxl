...
class vgl_h_matrix_2d_compute_rigid_body : public vgl_h_matrix_2d_compute
{
 protected:
  ...
  inline bool solve_rigid_body_problem(int equ_count,
 ...
 public:
  vgl_h_matrix_2d_compute_rigid_body()=default;
  int minimum_number_of_correspondences() const override { return 2; }
private:
    static constexpr int TM_UNKNOWNS_COUNT = 3;
    static constexpr double DEGENERACY_THRESHOLD = 0.01;
};
constexpr int vgl_h_matrix_2d_compute_rigid_body::TM_UNKNOWNS_COUNT;
constexpr double vgl_h_matrix_2d_compute_rigid_body::DEGENERACY_THRESHOLD;
