...
class vgl_quadric_3d
{
 ...
 private:
  ...
  T j_; //!< coefficient of \a w^2
    ...
    static const std::vector<std::string> quadric_class_name;
    static const int RANK_FACTOR = 100000;
    static const int DET_FACTOR = 100;
...
template <class T>
const std::vector<std::string> vgl_quadric_3d<T>::quadric_class_name = std::vector<std::string>({
    "invalid_quadric",
    "real_ellipsoid",
    "imaginary_ellipsoid",
    "hyperboloid_of_one_sheet",
