...
TEST(vgl_polygon, simple_polygon)
{
    ...
    EXPECT_EQ(p.contains( 0.0,  0.0 ), true );
    EXPECT_EQ(p.contains( 5.0,  0.0 ), true );
    EXPECT_EQ(p.contains( 5.0,  1.0 ), true );
    EXPECT_EQ(p.contains( 2.5,  0.0 ), true );
    EXPECT_EQ(p.contains( 2.5,  0.3 ), true );
    EXPECT_EQ(p.contains( 2.5,  0.5 ), true );
    EXPECT_EQ(p.contains( 5.0,  0.5 ), true );
    EXPECT_EQ(p.contains( 2.5,  0.6 ), false );
    EXPECT_EQ(p.contains( 5.1,  0.1 ), false );
    EXPECT_EQ(p.contains( 5.1,  0.0 ), false );
    EXPECT_EQ(p.contains( 5.0,  1.1 ), false );
    EXPECT_EQ(p.contains( 5.0, -0.1 ), false );
    EXPECT_EQ(p.contains( 2.0, -1.0 ), false );
    EXPECT_EQ(p.contains(-2.5, -0.5 ), false );
}

TEST(vgl_polygon, disjoint_polygon)
{
    ...
    EXPECT_EQ(p.contains(  2.5f,  0.3f ), true );
    EXPECT_EQ(p.contains( 12.5f, 10.3f ), true );
    EXPECT_EQ(p.contains(  2.5f,  0.6f ), false );
    EXPECT_EQ(p.contains(  5.0f,  1.1f ), false );
    EXPECT_EQ(p.contains(  5.1f,  0.0f ), false );
    EXPECT_EQ(p.contains(  2.0f, -1.0f ), false );
    EXPECT_EQ(p.contains( -2.5f, -0.5f ), false );
    EXPECT_EQ(p.contains( 12.5f, 10.6f ), false );
    EXPECT_EQ(p.contains( 15.0f,  9.0f ), false );
}
