...
TEST(affine_coordinates, simple)
{
  // basis
  ...
  EXPECT_EQ(good, true)<<"invariance of affine 2d coords \n";
  ...
  EXPECT_EQ(good, true)<<"invariance of affine 3d coords\n";
 ...
 std::vector<double> tc(2, 0.0);
  ...
  EXPECT_EQ(good, true)<<"affine 3-d coords from 2-d views\n";
  ...
  EXPECT_EQ(good, true)<<"Affine coordinates for face pts\n";
